...
MODEL_NAME = 'model'
IMAGE_NAME = r'./test_images/test_final.jpg'

image_path = r'./test_images/test_final.jpg'  # Giving the input image
# Givin the path to output image
output_path = r'./test_images/output/output.png'
...
#print("Print Name: ", text1[1])
  # Extracting name from the image
...
try:
    ...
    print("Extracted UID:", newlist[2][0:])
    uid_new = newlist[2][0:]  # New vid from the image
    for no in uid_new:
